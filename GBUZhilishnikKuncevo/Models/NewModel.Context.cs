...
namespace GBUZhilishnikKuncevo.Models
{
    ...
    public partial class menshakova_publicUtilitiesEntitiesNew : DbContext
    {
        public menshakova_publicUtilitiesEntitiesNew()
            : base("name=menshakova_publicUtilitiesEntitiesNew")
        {
        }
