...
namespace GBUZhilishnikKuncevo.Models
{
    ...
    public partial class menshakova_publicUtilitiesEntities2 : DbContext
    {
        public menshakova_publicUtilitiesEntities2()
            : base("name=menshakova_publicUtilitiesEntities2")
        {
        }
